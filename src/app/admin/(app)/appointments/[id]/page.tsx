...
export default async function AppointmentDetailPage({
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <Link href="/admin/dashboard" className="inline-flex items-center gap-1.5 text-sm text-[#888888] hover:text-[#F5F5F5]">
      ...
      <div className="rounded-xl border border-white/5 bg-[#1A1A1A] p-6">
        ...
        <Row label="Stylist" value={appointment.staff_name} />
